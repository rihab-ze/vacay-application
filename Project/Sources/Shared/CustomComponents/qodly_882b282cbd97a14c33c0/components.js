...
import exposesMap from './assets/virtualExposes-rie8vETR.js';
import { _ as __vitePreload } from './assets/preload-helper-CqoC6PUU.js';
import { q as qodly_882b282cbd97a14c33c0__mf_v__runtimeInit__mf_v__ } from './assets/qodly_882b282cbd97a14c33c0__mf_v__runtimeInit__mf_v__-W9EPimet.js';

const importMap = {
      
        "@ws-ui/craftjs-core": async () => {
          let pkg = await __vitePreload(() => import('./assets/index-CJNz_WOZ.js'),true              ?[]:void 0);
            return pkg;
        }
      ,
        "@ws-ui/craftjs-layers": async () => {
          let pkg = await __vitePreload(() => import('./assets/index-BjXOrG-t.js'),true              ?[]:void 0);
            return pkg;
        }
      ,
        "@ws-ui/craftjs-utils": async () => {
          let pkg = await __vitePreload(() => import('./assets/index-3_dEXQAj.js'),true              ?[]:void 0);
            return pkg;
        }
      ,
        "@ws-ui/shared": async () => {
          let pkg = await __vitePreload(() => import('./assets/index.es-DVUopg8L.js'),true              ?[]:void 0);
            return pkg;
        }
      ,
        "@ws-ui/webform-editor": async () => {
          let pkg = await __vitePreload(() => import('./assets/index.es-BfrcNDxv.js').then(n => n.r),true              ?[]:void 0);
            return pkg;
        }
      ,
        "react": async () => {
      ...
      ,
        "react-dom": async () => {
          let pkg = await __vitePreload(() => import('./assets/index-CHC1HraU.js').then(n => n.i),true              ?[]:void 0);
            return pkg;
        }
      ,
        "react/jsx-runtime": async () => {
          let pkg = await __vitePreload(() => import('./assets/jsx-runtime-CIR5-D_o.js').then(n => n.j),true              ?[]:void 0);
            return pkg;
        }
