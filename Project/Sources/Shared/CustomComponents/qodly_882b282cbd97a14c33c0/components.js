import { i as init_1, q as qodly_882b282cbd97a14c33c0__mf_v__runtimeInit__mf_v__ } from './assets/qodly_882b282cbd97a14c33c0__mf_v__runtimeInit__mf_v__-BIorW6lM.js';
import exposesMap from './assets/virtualExposes-Bsryf80l.js';
import { _ as __vitePreload } from './assets/preload-helper-CqoC6PUU.js';

const importMap = {
      
        "@ws-ui/craftjs-core": async () => {
          let pkg = await __vitePreload(() => import('./assets/index-27XTELpj.js'),true              ?[]:void 0);
          return pkg
        }
      ,
        "@ws-ui/craftjs-layers": async () => {
          let pkg = await __vitePreload(() => import('./assets/index-iDzL5HCX.js'),true              ?[]:void 0);
          return pkg
        }
      ,
        "@ws-ui/craftjs-utils": async () => {
          let pkg = await __vitePreload(() => import('./assets/index-DQ2JJMyx.js'),true              ?[]:void 0);
          return pkg
        }
      ,
        "@ws-ui/shared": async () => {
          let pkg = await __vitePreload(() => import('./assets/index.es-BoqfNxJV.js'),true              ?[]:void 0);
          return pkg
        }
      ,
        "@ws-ui/webform-editor": async () => {
          let pkg = await __vitePreload(() => import('./assets/index.es-VT5e_LEf.js').then(n => n.i),true              ?[]:void 0);
          return pkg
        }
      ,
        "react": async () => {
      ...
      ,
        "react-dom": async () => {
          let pkg = await __vitePreload(() => import('./assets/index-BzXHTbSZ.js').then(n => n.i),true              ?[]:void 0);
          return pkg
        }
      ,
        "react/jsx-runtime": async () => {
          let pkg = await __vitePreload(() => import('./assets/jsx-runtime-BrzfDJCo.js').then(n => n.j),true              ?[]:void 0);
          return pkg
        }
      ...
      const usedShared = {
          ...
          "@ws-ui/craftjs-core": {
            ...
            scope: ["default"],
            loaded: false,
            from: "qodly_882b282cbd97a14c33c0",
            async get () {
...
const initTokens = {};
  ...
  const mfName = "qodly_882b282cbd97a14c33c0";
  async function init(shared = {}, initScope = []) {
    ...
    qodly_882b282cbd97a14c33c0__mf_v__runtimeInit__mf_v__.initResolve(initRes);
    return initRes
  }
