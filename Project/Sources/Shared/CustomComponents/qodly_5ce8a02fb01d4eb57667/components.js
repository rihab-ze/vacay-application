import { i as init_1, q as qodly_5ce8a02fb01d4eb57667__mf_v__runtimeInit__mf_v__ } from './assets/qodly_5ce8a02fb01d4eb57667__mf_v__runtimeInit__mf_v__-ONSZE_L_.js';
import exposesMap from './assets/virtualExposes-BmwkwQUH.js';
import { _ as __vitePreload } from './assets/preload-helper-CqoC6PUU.js';

const importMap = {
      
        "@ws-ui/craftjs-core": async () => {
          let pkg = await __vitePreload(() => import('./assets/index-CVf0Ug8F.js'),true              ?[]:void 0);
          return pkg
        }
      ,
        "@ws-ui/craftjs-layers": async () => {
          let pkg = await __vitePreload(() => import('./assets/index-k6e606ha.js'),true              ?[]:void 0);
          return pkg
        }
      ,
        "@ws-ui/craftjs-utils": async () => {
          let pkg = await __vitePreload(() => import('./assets/index-v_L1wOYO.js'),true              ?[]:void 0);
          return pkg
        }
      ,
        "@ws-ui/shared": async () => {
          let pkg = await __vitePreload(() => import('./assets/index.es-BiccdSsm.js'),true              ?[]:void 0);
          return pkg
        }
      ,
        "@ws-ui/webform-editor": async () => {
          let pkg = await __vitePreload(() => import('./assets/index.es-BGNQKy9S.js').then(n => n.i),true              ?[]:void 0);
          return pkg
        }
      ,
        "react": async () => {
      ...
      ,
        "react-dom": async () => {
          let pkg = await __vitePreload(() => import('./assets/index-ABWF4t1_.js').then(n => n.i),true              ?[]:void 0);
          return pkg
        }
      ,
        "react/jsx-runtime": async () => {
          let pkg = await __vitePreload(() => import('./assets/jsx-runtime-ReoiqIrN.js').then(n => n.j),true              ?[]:void 0);
          return pkg
        }
      ...
      const usedShared = {
          ...
          "@ws-ui/craftjs-core": {
            ...
            scope: ["default"],
            loaded: false,
            from: "qodly_5ce8a02fb01d4eb57667",
            async get () {
...
const initTokens = {};
  ...
  const mfName = "qodly_5ce8a02fb01d4eb57667";
  async function init(shared = {}, initScope = []) {
    ...
    qodly_5ce8a02fb01d4eb57667__mf_v__runtimeInit__mf_v__.initResolve(initRes);
    return initRes
  }
